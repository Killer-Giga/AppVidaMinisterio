    ...
    internal class WeekPdfTemplate : IDocument
    {
        ...
        void ComposeHeader(IContainer container)
        {
            container.Row(row =>
           {
               ...
               {
                   column.Item().Text(Week.SemanaFecha).FontSize(20).Bold().AlignCenter().FontColor(Colors.FromHex("#000000"));
                   column.Item().Text(Week.TextoBiblico).FontSize(15).Bold().AlignCenter();
